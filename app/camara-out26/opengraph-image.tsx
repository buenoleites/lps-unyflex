...
export const alt =
  "Câmaras Municipais: Orçamento/LOA 2027 · curso presencial em Curitiba · 13 a 16/10 · 17 horas";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Câmaras Municipais: Orçamento/LOA 2027
        </div>
        <div
          style={{
            fontSize: "26px",
        ...
        >
          A LOA 2027 chega à Câmara em outubro. Receita inflada e cheque em
          branco passam se ninguém ler.
        </div>
      </div>
    ),
    { ...size }
